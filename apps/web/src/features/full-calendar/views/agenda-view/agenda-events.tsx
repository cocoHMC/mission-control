...
import {
  ...
  CommandItem,
  CommandList,
} from "@/features/full-calendar/ui/command";
...
export const AgendaEvents: FC = () => {
  ...
  return (
    <Command className="h-full min-h-0 bg-transparent">
      <div className="shrink-0 px-4 py-3">
        <CommandInput placeholder="Type a command or search..." />
      </div>
      <CommandList className="max-h-none min-h-0 flex-1 overflow-auto border-t px-3 mc-scroll">
