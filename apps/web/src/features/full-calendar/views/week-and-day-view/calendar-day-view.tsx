...
import { DayPicker } from "@/features/full-calendar/ui/day-picker";
...
import { groupEvents } from "@/features/full-calendar/helpers";
import type { IEvent } from "@/features/full-calendar/interfaces";
import { CalendarTimeline } from "@/features/full-calendar/views/week-and-day-view/calendar-time-line";
import { DayViewMultiDayEventsRow } from "@/features/full-calendar/views/week-and-day-view/day-view-multi-day-events-row";
import { RenderGroupedEvents } from "@/features/full-calendar/views/week-and-day-view/render-grouped-events";
  ...
  return (
    <div className="h-full min-h-0 overflow-hidden rounded-xl border bg-background">
      <div className="flex h-full min-h-0">
        ...
        <div className="hidden w-72 min-h-0 divide-y border-l md:block">
          <DayPicker
