  ...
  const collections = [
    ...
    },
    {
      ...
      schema: [
        ...
        { type: 'text', name: 'openclawWorkspacePath' },
      ...
      indexes: [
        ...
        "CREATE UNIQUE INDEX `idx_openclaw_workspace_workspaces` ON `workspaces` (`openclawWorkspacePath`) WHERE `openclawWorkspacePath` != ''",
